...
module OpenapiClient
  class InlineResponse2002
    ...
    def valid?
      account_status_validator = EnumAttributeValidator.new('String', ["Expiry request sent to WhatsApp", "Expiry request not sent because substatus don't equals \"expired\""])
    ...
    def account_status=(account_status)
      validator = EnumAttributeValidator.new('String', ["Expiry request sent to WhatsApp", "Expiry request not sent because substatus don't equals \"expired\""])
