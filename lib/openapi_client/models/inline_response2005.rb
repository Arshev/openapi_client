...
module OpenapiClient
  class InlineResponse2005
    ...
    def hash
      [webhook_url, ack_notifications_on, chat_update_on, video_upload_on, proxy, guaranteed_hooks, ignore_old_messages, process_archive, instance_statuses, webhook_statuses, status_notifications_on, update].hash
    end
