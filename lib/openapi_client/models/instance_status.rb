  ...
  class InstanceStatus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InstanceStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InstanceStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'status_data')
        self.status_data = attributes[:'status_data']
      end
    end
    ...
    def valid?
      account_status_validator = EnumAttributeValidator.new('String', ["got qr code", "authenticated", "loading", "init", "not_paid"])
    ...
    def account_status=(account_status)
      validator = EnumAttributeValidator.new('String', ["got qr code", "authenticated", "loading", "init", "not_paid"])
    ...
    def hash
      [account_status, qr_code, status_data].hash
    end
