  ...
  class SendLinkRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SendLinkRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SendLinkRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'preview_base64')
        self.preview_base64 = attributes[:'preview_base64']
      end
    ...
    def list_invalid_properties
      ...
      if @preview_base64.nil?
        invalid_properties.push('invalid value for "preview_base64", preview_base64 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @preview_base64.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          phone == o.phone &&
          body == o.body &&
          preview_base64 == o.preview_base64 &&
          title == o.title &&
    ...
    def hash
      [chat_id, phone, body, preview_base64, title, description].hash
    end
