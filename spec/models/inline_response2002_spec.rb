...
describe 'InlineResponse2002' do
  ...
  describe 'test attribute "account_status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Expiry request sent to WhatsApp", "Expiry request not sent because substatus don't equals \"expired\""])
